...
template <class ELFT> void Writer<ELFT>::addSectionSymbols() {
  ...
  for (SectionCommand *base : script->sectionCommands) {
    ...
    Defined *sym;
    if (isIRIX)
        sym = makeDefined(isec->file, isec->getOutputSection()->name, STB_LOCAL, /*stOther=*/0, STT_SECTION,
                      /*value=*/0, /*size=*/isec->getSize(), isec->getOutputSection());
    else
        sym = makeDefined(isec->file, "", STB_LOCAL, /*stOther=*/0, STT_SECTION,

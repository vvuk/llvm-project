...
macro(test_target_arch arch def)
  ...
  foreach(arg ${ARGN})
    set(argstring "${argstring} ${arg}")
  endforeach()
  message("test_target_arch ${arch} ${CAN_TARGET_${arch}}")
...
macro(construct_compiler_rt_default_triple)
  ...
  if("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "^mips64$" AND "${COMPILER_RT_DEFAULT_TARGET_TRIPLE}" MATCHES "-sgi-irix6.5-gnuabin32")
    set(COMPILER_RT_DEFAULT_TARGET_ARCH "mipsn32")
  endif()
...
function(get_compiler_rt_target arch variable)
  ...
  elseif(DEFINED COMPILER_RT_${arch}_TRIPLE)
    message("SETTING ${arch} -> ${COMPILER_RT_${arch}_TRIPLE}")
    set(target "${COMPILER_RT_${arch}_TRIPLE}")
  else()

...
set(ALL_CRT_SUPPORTED_ARCH ${X86} ${X86_64} ${ARM32} ${ARM64} ${RISCV32} ${RISCV64} ${VE} ${MIPS32} ${MIPS64})
...
if (CRT_SUPPORTED_ARCH AND OS_NAME MATCHES "Linux|IRIX" AND NOT LLVM_USE_SANITIZER)
